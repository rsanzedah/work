...
public class feedsLocators {
	...
	public static final By Listings = By.xpath("//*[@id=\"main-container\"]/ng-component/page/div/div/div[2]/div[2]/h1");
	...
	//public static final By ShowALlRequests = By.className("show-more");
	
	//*[@id="header-requests"]/ul/li[2]/a
	...
	public static final By OMBAnalystShowAll = By.xpath("//*[@id=\"header-requests\"]/ul/li[3]/a");
