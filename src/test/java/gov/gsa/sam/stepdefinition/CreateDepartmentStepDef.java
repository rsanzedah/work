...
public class CreateDepartmentStepDef {
	...
	public static String  EditDepartmentCFDACodetext1;
	 ...
	 public static String EditDepartmentShortNametext1;
	  ...
	  public static String  DepartmentStartMonth;
	  public static String DepartmentStartDay;
	  public static String DepartmentStartYear;
	  public static String SubTierStartDateMonth1;
	  public static String SubTierStartDateDay1;
	  public static String SubTierStartDateYear1;
	  public static String SubTierEndDateMonth1;
	  public static String SubTierEndDateDay1;
	  public static String SubTierEndDateYear1;
	...
	public void the_User_Enter_Start_Month(String startMonth) throws Throwable {
		...
		DepartmentStartMonth  = DateClass.getMonthName(i, TextStyle.SHORT);
	...
	public void The_User_Enters_Start_Day(String startDay) throws Throwable {
		...
		DepartmentStartDay = DateClass.getCurrentDay();
	...
	public void The_User_Enters_Start_Year(String startYear) throws Throwable {
		...
		DepartmentStartYear = DateClass.getCurrentYear();
	...
	public void the_User_Enters_End_Month(String endMonth) throws Throwable {
		...
		logger.info("Month: ==" + DepartmentField.Month);
		Assert.assertEquals((DepartmentField.Month), expected3); 
		String EndMonth11 = DateClass.addOrSubDaysFromCurrentDate(2,"month");
		int i=Integer.parseInt(EndMonth11);  
		CreateendMonth  = DateClass.getMonthName(i, TextStyle.SHORT);
	...
	public void the_User_Enters_End_Day(String endDay) throws Throwable {
		...
		CreateendDay = DateClass.addOrSubDaysFromCurrentDate(2,"day");
	...
	public void the_User_Enters_End_Year(String endYear) throws Throwable {
		...
		CreateendYear = DateClass.addOrSubDaysFromCurrentDate(2,"year");
...
//WebElement elt3 = driver.findElement(DepartmentLocators.submit);
	...
	public void the_User_Click_On_The_Confirmation_Department_Submit_Button() throws Throwable {
		logger.info("confirmation and click on Submit button ", scenario);
		...
		String expected201 = driver.findElement(DepartmentCreateLocators.AgencyNameText).getText().trim();
		logger.info("Agency Name: " + expected201);
		logger.info("Agency Name: ==" + agencyName);
		Assert.assertEquals(agencyName, expected201);
		Thread.sleep(1000);
		...
		String expected222 = driver.findElement(DepartmentCreateLocators.ConfirmationStartDateText).getText().trim();
		logger.info("Start Date Text " + expected222);
		logger.info("DepartmentStartMonth :" + DepartmentStartMonth );
		logger.info("DepartmentStartDay: " + DepartmentStartDay );
		logger.info("DepartmentStartYear: " + DepartmentStartYear );
	
		Assert.assertTrue( expected222.contains( DepartmentStartMonth ));
		Assert.assertTrue( expected222.contains( DepartmentStartDay ));
		Assert.assertTrue( expected222.contains( DepartmentStartYear ));
		Thread.sleep(1000);
		...
		String expected223 = driver.findElement(DepartmentCreateLocators.ConfirmationEndDateText).getText().trim();
		logger.info("End Date Text " + expected223);
		//String EndVal = CreateendMonth.concat(CreateendDay).concat(CreateendYear);
		logger.info("CreateendMonth: ==" + CreateendMonth );
		logger.info("CreateendDay: ==" + CreateendDay );
		logger.info("CreateendYear: ==" + CreateendYear );
		
		Assert.assertTrue( expected223.contains(CreateendMonth));
		Assert.assertTrue( expected223.contains(CreateendDay));
		Assert.assertTrue( expected223.contains(CreateendYear));
	...
	public void the_User_Enters_Edit_End_Month(String editEndMonth) {
		...
		String EditEndMonth11 = DateClass.addOrSubDaysFromCurrentDate(1,"month");
		int i=Integer.parseInt(EditEndMonth11);  
		EditDepartmentEndMonth  = DateClass.getMonthName(i, TextStyle.SHORT);
		
		driver.findElement(DepartmentLocators.endMonth).clear();
		//EditDepartmentEndMonth = DateClass.addOrSubDaysFromCurrentDate(1,"month");
		driver.findElement(DepartmentLocators.endMonth).sendKeys(DateClass.addOrSubDaysFromCurrentDate(1,"month"));
	...
	public void user_Click_On_Edit_Agency_Code_Submit_Button() throws Throwable {
		...
		String EditDepartmentStartDataText1 = driver.findElement(DepartmentCreateLocators.EditDepartmentStartDataText).getText();
		logger.info("EditDepartmentStartDataText1 "+ EditDepartmentStartDataText1);
		logger.info("DepartmentStartMonth :" + DepartmentStartMonth );
		logger.info("DepartmentStartDay: " + DepartmentStartDay );
		logger.info("DepartmentStartYear: " + DepartmentStartYear );
	
		Assert.assertTrue( EditDepartmentStartDataText1.contains( DepartmentStartMonth ));
		Assert.assertTrue( EditDepartmentStartDataText1.contains( DepartmentStartDay ));
		Assert.assertTrue( EditDepartmentStartDataText1.contains( DepartmentStartYear ));
		Thread.sleep(1000);
		
		String EditDepartmentEndDateText1 = driver.findElement(DepartmentCreateLocators.EditDepartmentEndDataText).getText();
		logger.info("EditDepartmentEndDateText1 "+  EditDepartmentEndDateText1);
		logger.info("EditDepartmentEndMonth :" + EditDepartmentEndMonth );
		logger.info("EditDepartmentEndDay: " + EditDepartmentEndDay );
		logger.info("EditDepartmentEndYear: " + EditDepartmentEndYear );
		
		Assert.assertTrue( EditDepartmentEndDateText1.contains( EditDepartmentEndMonth ));
		Assert.assertTrue( EditDepartmentEndDateText1.contains( EditDepartmentEndDay ));
		Assert.assertTrue( EditDepartmentEndDateText1.contains( EditDepartmentEndYear ));
		Thread.sleep(5000);
	...
	public void the_user_enters_sub_tier_detail(String SubTierName) throws Throwable {
		Thread.sleep(5000);
	...
	public void the_user_enters_sub_tier_start_month(String startMonth) {
		...
		String startMonth11 = DateClass.getCurrentMonth();
		int i=Integer.parseInt(startMonth11);  
		SubTierStartDateMonth1  = DateClass.getMonthName(i, TextStyle.SHORT);
	...
	public void the_user_enters_sub_tier_start_day(String startDay) {
		...
		SubTierStartDateDay1 = DateClass.getCurrentDay() ;
	...
	public void the_user_enters_sub_tier_start_year(String startYear) {
		...
		SubTierStartDateYear1 =DateClass.getCurrentYear();
	...
	public void the_user_enters_sub_tier_end_month(String endMonth) {
		...
		int i=Integer.parseInt(startMonth11);  
		SubTierEndDateMonth1  = DateClass.getMonthName(i, TextStyle.SHORT);
	...
	public void the_user_enters_sub_tier_end_day(String endDay) {
		...
		SubTierEndDateDay1 = DateClass.addOrSubDaysFromCurrentDate(2,"day");
		driver.findElement(DepartmentLocators.endDay).clear();
		driver.findElement(DepartmentLocators.endDay).sendKeys(DateClass.addOrSubDaysFromCurrentDate(2,"day"));
	...
	public void the_user_enters_sub_tier_end_year(String endYear) throws InterruptedException {
		...
		SubTierEndDateYear1 = DateClass.addOrSubDaysFromCurrentDate(2,"year");
		driver.findElement(DepartmentLocators.endYear).clear();
		driver.findElement(DepartmentLocators.endYear).sendKeys(DateClass.addOrSubDaysFromCurrentDate(2,"year"));
	...
	public void the_user_click_on_the_sub_tier_confirm_button() throws InterruptedException {
		...
		String expected222 = driver.findElement(DepartmentCreateLocators.ConfirmationSubTierStartDataText).getText().trim();
		logger.info("Start Date Text " + expected222);
		logger.info("SubTierStartMonth :" + SubTierStartDateMonth1 );
		logger.info("SubTiertStartDay: " + SubTierStartDateDay1 );
		logger.info("SubTierStartYear: " + SubTierStartDateYear1 );
		
		Assert.assertTrue( expected222.contains( SubTierStartDateMonth1 ));
		Assert.assertTrue( expected222.contains( SubTierStartDateDay1 ));
		Assert.assertTrue( expected222.contains( SubTierStartDateYear1 ));
		...
		String expected223 = driver.findElement(DepartmentCreateLocators.ConfirmationSubTierEndDataText).getText().trim();
		logger.info("End Date Text " + expected223);
		logger.info("SubTierEndMonth :" + SubTierEndDateMonth1 );
		logger.info("SubTiertEndDay: " + SubTierEndDateDay1 );
		logger.info("SubTierEndYear: " + SubTierEndDateYear1 );
		
		Assert.assertTrue( expected223.contains( SubTierEndDateMonth1 ));
		Assert.assertTrue( expected223.contains( SubTierEndDateDay1 ));
		Assert.assertTrue( expected223.contains( SubTierEndDateYear1 ));
	...
	public void user_navigate_to_sub_Tier_profile_page() throws Throwable {
		Thread.sleep(5000);
	...
	public void The_user_click_on_edit_sub_tier_detail() throws Throwable {
        ...
        Thread.sleep(5000);
		String EditSubTierDetails = driver.findElement(DepartmentLocators.EditSubTierDetails).getText();
		logger.info("EditSubTierDetails: " + EditSubTierDetails);
		logger.info("DepartmentField.EditSubTierDetails: " + DepartmentField.EditSubTierDetails);
		Assert.assertEquals(DepartmentField.EditSubTierDetails, EditSubTierDetails);
		
		String EditSubTierDepartment = driver.findElement(DepartmentLocators.EditSubTierDepartment).getText();
		logger.info("EditSubTierDepartment: " + EditSubTierDepartment);
		logger.info("DepartmentField.EditSubTierDepartment: " + DepartmentField.EditSubTierDepartment);
		Assert.assertEquals(DepartmentField.EditSubTierDepartment, EditSubTierDepartment);
		
		String EditSubTierStartDate = driver.findElement(DepartmentLocators.EditSubTierStartDate).getText();
		logger.info("EditSubTierStartDate: " + EditSubTierStartDate);
		logger.info("DepartmentField.EditSubTierStartDate: " + DepartmentField.EditSubTierStartDate);
		Assert.assertEquals(DepartmentField.EditSubTierStartDate, EditSubTierStartDate);
		
		String EditSubTierEndDate = driver.findElement(DepartmentLocators.EditSubTierEndDate).getText();
		logger.info("EditSubTierEndDate: " + EditSubTierEndDate);
		logger.info("DepartmentField.EditSubTierEndDate: " + DepartmentField.EditSubTierEndDate);
		Assert.assertEquals(DepartmentField.EditSubTierEndDate, EditSubTierEndDate);
		
		String EditSubTierShortname = driver.findElement(DepartmentLocators.EditSubTierShortname).getText();
		logger.info("EditSubTierShortname: " + EditSubTierShortname);
		logger.info("DepartmentField.EditSubTierShortname: " + DepartmentField.EditSubTierShortname);
		Assert.assertEquals(DepartmentField.EditSubTierShortname, EditSubTierShortname);
		
		String EditSubTierAgencyCode = driver.findElement(DepartmentLocators.EditSubTierAgencyCode).getText();
		logger.info("EditSubTierAgencyCode: " + EditSubTierAgencyCode);
		logger.info("DepartmentField.EditSubTierAgencyCode: " + DepartmentField.EditSubTierAgencyCode);
		Assert.assertEquals(DepartmentField.EditSubTierAgencyCode, EditSubTierAgencyCode);
	...
	public void The_user_edit_sub_tier_end_month(String endMonth) { 
		String EditSubTierEndDateHint = driver.findElement(DepartmentLocators.EditSubTierEndDateHint).getText();
		logger.info("EditSubTierEndDateHint: " + EditSubTierEndDateHint);
		logger.info("DepartmentField.EditSubTierEndDateHint: " + DepartmentField.EditSubTierEndDateHint);
		Assert.assertEquals(DepartmentField.EditSubTierEndDateHint, EditSubTierEndDateHint);
		
		String startMonth11 = DateClass.addOrSubDaysFromCurrentDate(1,"month");
		int i=Integer.parseInt(startMonth11);  
		EditSubTierEndMonth  = DateClass.getMonthName(i, TextStyle.SHORT);
	...
	public void The_user_edit_sub_tier_shortName(String shortName) {
		String EditSubTierShortNamHint = driver.findElement(DepartmentLocators.EditSubTierShortNamHint).getText();
		logger.info("EditSubTierShortNamHint: " + EditSubTierShortNamHint);
		logger.info("DepartmentField.EditSubTierEndDateHint: " + DepartmentField.EditSubTierShortNamHint);
		Assert.assertEquals(DepartmentField.EditSubTierShortNamHint, EditSubTierShortNamHint);
	...
	public void The_user_edit_sub_tier_Agency_codes(String agencyCode) {
		String EditSubTierAgencyCodeHint = driver.findElement(DepartmentLocators.EditSubTierAgencyCodeHint).getText();
		logger.info("EditSubTierAgencyCodeHint: " + EditSubTierAgencyCodeHint);
		logger.info("DepartmentField.EditSubTierAgencyCodeHint: " + DepartmentField.EditSubTierAgencyCodeHint);
		Assert.assertEquals(DepartmentField.EditSubTierAgencyCodeHint, EditSubTierAgencyCodeHint);
	...
	public void the_user_click_on_the_sub_tier_codes_submit_button() throws Throwable {
		...
		logger.info("The user click on the sub tier codes submit button", scenario);
			...
			String expected222 = driver.findElement(DepartmentCreateLocators.EditSubTierStartDataText).getText().trim();
			logger.info("Start Date Text " + expected222);
			logger.info("SubTierStartMonth :" + SubTierStartDateMonth1 );
			logger.info("SubTiertStartDay: " + SubTierStartDateDay1 );
			logger.info("SubTierStartYear: " + SubTierStartDateYear1 );
			...
			String expected223 = driver.findElement(DepartmentCreateLocators.EditSubTierEndDataText).getText().trim();
			logger.info("End Date Text " + expected223);
			logger.info("SubTierEndMonth :" + EditSubTierEndMonth );
			logger.info("SubTiertEndDay: " + EditSubTierEndDay );
			logger.info("SubTierEndYear: " + EditSubTierEndYear );
			
			Assert.assertTrue( expected223.contains( EditSubTierEndMonth ));
			Assert.assertTrue( expected223.contains( EditSubTierEndDay));
			Assert.assertTrue( expected223.contains( EditSubTierEndYear));
		
		String  EditSubTierDepartmentText = driver.findElement(DepartmentLocators.EditSubTierDepartmentText).getText();
		logger.info("EditSubTierDepartmentText: " + EditSubTierDepartmentText);
		logger.info("agencyName: " + agencyName);
		//Assert.assertEquals(EditSubTierDepartmentText,agencyName );
		Thread.sleep(5000);
		
		String  EditSubTierShortnameText = driver.findElement(DepartmentLocators.EditSubTierShortnameText).getText();
		logger.info("EditSubTierShortnameText: " + EditSubTierShortnameText);
		logger.info("EditSubTierShortName: " + EditSubTierShortName);
		Assert.assertEquals(EditSubTierShortnameText,EditSubTierShortName );
		Thread.sleep(5000);
		
		String  EditSubTierAgencyCodeText = driver.findElement(DepartmentLocators.EditSubTierAgencyCodeText).getText().trim();
		logger.info("EditSubTierAgencyCodeText: " + EditSubTierAgencyCodeText);
		logger.info("EditSubTierAgencyCode: " + EditSubTierAgencyCode);
		Assert.assertEquals(EditSubTierAgencyCode.trim(),EditSubTierAgencyCodeText );
		  Thread.sleep(2000);
	}
	...
	public void Reading_details_in_account_details_page() throws Throwable {
	 ...
	 @Given ("^Department browser sign out$")
              public void Department_browser_signout() {
		 driver.close();
		 driver.quit();
	 }
}
