...
public class CreateOfficeFields {
	...
	public static String FH6 = "Please provide necessary details required for the office edit";
	//public static String FH5 = "Provide the office name. Office name should be unique and has to be less than 35 characters, including spaces.";
	public static String FH5 = "Provide the office name. Office name should be unique.";
	...
	// public static String OfficeNameText = "Provide the office name. Office name
	// has to be unique and be less than 35 characters, including spaces.";
	...
	public static String OfficeNameText = "Provide the office name.";
	...
	// public static String ContractAwards2 = "ContractAwards office type end date
	// cannot be earlier than office start date";
	...
	public static String EmailSubj = "Federal Hierarchy - New office request submitted";
	//public static String originalString = "Your request for the office 409 under the department Department0.10280681 and the sub-tier PI18_IP has been submitted for approval.";
	public static String requestStringFormat  = "Your request for the office %s under the department %s and the sub-tier %s has been submitted for approval.";
	
	
	public static String requestStringFormat1  = "A new request has been made for the office %s under the department %s and the sub-tier %s.\r\n" + 
			"\r\n" + 
			"Details of this request are provided in the attached XML file. Please take necessary action.\r\n" + 
			"\r\n" + 
			"If you need additional assistance, contact the Federal Service Desk";
	
	public static String requestStringFormat2  = "Dear Shanthi Dutta,\r\n" + 
			"\r\n" + 
			"Your request for the office %s under the department %s and the sub-tier %s has been submitted for approval.\r\n" + 
			"\r\n" + 
			"If you need additional assistance, contact the Federal Service Desk";
	
	public static String ACC1  = "Provide an AAC that you would like the office to be associated with. AAC you are requesting may not be the final AAC assigned to the office, as the administrator will validate the AAC for accuracy and assign an AAC for the office.";
	public static String ACC2  = "An AAC consists of 6 digits. First 2 digits are the Agency Code (also called as TAS-2 code) derived from a TAS code. Remaining 4 digits can be random alphanumeric (capital letters only) except 'I' and 'O'.";
	public static String EditRequest  = "Edit Office Completed";
	public static String EditRequestbody1  = "Success! Office details for %s are updated." ; 
	public static String EditRequestbody2  = "You will receive an email confirming your office edit request. If you have requested edits to the office name, an administrator will review your request and take further action. The rest of your updates will be reflected immediately on the office profile.";
