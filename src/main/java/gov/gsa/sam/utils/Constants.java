...
public class Constants {
	    ...
	    public static final String samDotGovLogin = "https://alpha.sam.gov/signin";

	    // login credentials
	    public static final String userEmail = "shah.raiaan+coSelenium@gsa.gov";
	    public static final String userPass = "Test@1234@1234";
	    public static String pass;

	    public static final String GMAIL_USERNAME = "shanthi.dutta@gsa.gov";
	    ...
	    // roles
	    public static final String ROLE_CONTRACTING_SPECIALIST = "Contracting Specialist";
	    ...
	    public static String RequestOfficeEmail;
